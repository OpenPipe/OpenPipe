...
class UnstableDatasetEntryCreateRequestEntriesItemToolChoiceFunction(pydantic.BaseModel):
    type: typing.Optional[typing_extensions.Literal["function"]]
    function: typing.Optional[UnstableDatasetEntryCreateRequestEntriesItemToolChoiceFunctionFunction]
