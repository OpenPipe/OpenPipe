...
class CreateChatCompletionResponseChoicesChoicesItemLogprobsContentItem(pydantic.BaseModel):
    token: str
    bytes: typing.Optional[typing.List[float]]
    logprob: float
    top_logprobs: typing.List[CreateChatCompletionResponseChoicesChoicesItemLogprobsContentItemTopLogprobsItem]
