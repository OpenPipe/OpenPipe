...
from ..models.create_chat_completion_json_body_req_payload_messages_item_type_1_content_type_1 import (
...
class CreateChatCompletionJsonBodyReqPayloadMessagesItemType1:
    ...
    Attributes:
        ...
        content (Union[CreateChatCompletionJsonBodyReqPayloadMessagesItemType1ContentType1, str]):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.content, CreateChatCompletionJsonBodyReqPayloadMessagesItemType1ContentType1):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_content(
            data: object,
        ) -> Union[CreateChatCompletionJsonBodyReqPayloadMessagesItemType1ContentType1, str]:
            try:
                if not isinstance(data, str):
                    raise TypeError()
                _content_type_1 = data
                content_type_1: Optional[CreateChatCompletionJsonBodyReqPayloadMessagesItemType1ContentType1]
                if _content_type_1 is None:
                    content_type_1 = UNSET
                else:
                    content_type_1 = CreateChatCompletionJsonBodyReqPayloadMessagesItemType1ContentType1(
                        _content_type_1
                    )
                ...
                pass
            return cast(Union[CreateChatCompletionJsonBodyReqPayloadMessagesItemType1ContentType1, str], data)
