...
class CreateChatCompletionResponseChoicesItemMessageToolCallsItem(pydantic.BaseModel):
    id: str
    function: CreateChatCompletionResponseChoicesItemMessageToolCallsItemFunction
